...
curl -fsS https://qolab.kz/healthz >/dev/null
public_api_status="$(curl -sS -o /dev/null -w '%{http_code}' https://qolab.kz/api/v1/tenders)"
public_rag_status="$(curl -sS -o /dev/null -w '%{http_code}' https://qolab.kz/rag/health)"
